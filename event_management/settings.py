...
ALLOWED_HOSTS = [
    "event-management-project-0b7x.onrender.com",  # your Render domain
    "localhost",
    "127.0.0.1",
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # add your custom template dirs here if needed
        'APP_DIRS': True,  # searches for templates inside app folders
        'OPTIONS': {
            'context_processors': [
